...
import useShare from 'decentraland-connect/esm/hooks/useShare'
...
- [`useShareContext`](./?path=/docs/context-share-usesharecontext--docs): use a single instance of `useShare` injected through a provider
