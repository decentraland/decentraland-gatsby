...
export default React.memo(function Rollbar({
  ...
  if (!accessToken) {
    console.warn(`skipping rollbar inject: accessToken and GATSBY_ROLLBAR_TOKEN is missing'`)
    return null
  }
