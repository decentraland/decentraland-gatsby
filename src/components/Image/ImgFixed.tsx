...
export default function ImgFixed({ src, dimension, size, background, position, ...props }: ImgFixedProps) {
  ...
  >
    {(!dimension || dimension === 'square' || dimension === 'circle') && <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR4AWNwL/BhAAADCQEEiiqnjQAAAABJRU5ErkJggg==" width="1" height="1" />}
    ...
    {dimension === 'vertical' && <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAIAAAADCAYAAAC56t6BAAAAD0lEQVR4AWNwL/ABY0wGAFT5BhPIHHvgAAAAAElFTkSuQmCC" width="2" height="3" />}
  </div>
}