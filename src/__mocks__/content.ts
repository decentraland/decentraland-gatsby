...
export const worldContent: ContentDeploymentWorld = {
  ...
  content: [
    ...
    {
      file: 'bin/game.js',
      hash: 'bafkreifrhgvhhjsegcku7a7alxopq7t7kbtroldfsbhqexqvq4cjo3zzmi',
    },
    {
      file: 'bin/game.js.lib',
      hash: 'bafkreif32eeqqld2efstvgc3w7wjwfbklphg27dascpcatn4bpphyhvede',
    },
    {
      file: 'builder.json',
      hash: 'bafkreid2e3o3utgi54u3xtsj7ome6oxwhcqm7nyjzvt7fcmeumesai7mhu',
    },
    {
    ...
    {
      file: 'scene.json',
      hash: 'bafkreifwwzd7l473fj7f5kx4yjnxbyufqr3k22sds7haggfo7yz2evar4a',
    },
  ],
  metadata: {
    display: {
