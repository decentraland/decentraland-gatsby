...
describe(__filename, () => {
  ...
  test(`l.isEmpty("paragraph")`, () => expect(l.isEmpty('paragraph')).toBe(false))

  test(`l.str("invalid")`, () => expect(l('invalid')).toBe(null))
  test(`l.str("empty")`, () => expect(l('empty')).toBe(null))
  test(`l.str("paragraph")`, () => expect(l('paragraph', { value: 2 })).toBe('1rt paragraph: regular message with data: 2.'))
  ...
  test(`l("paragraph")`, () => expectRender(l.markdown('paragraph', { value: 1 }), <Paragraph>1rt paragraph: regular message with data: 1.</Paragraph>))
  test(`l("decorations")`, () => expectRender(l.markdown('decorations'), <Paragraph>2nd paragraph: <Italic>italic</Italic>, <Bold>bold</Bold>, <Link target="" href="#">innerLink</Link> and <Link target="_blank" href="https://decentraland.com">outerLink</Link>.</Paragraph>))
  ...
  test(`l("code")`, () => expectRender(l.markdown('code'), <>
    <Paragraph>code block:</Paragraph>
    <Code>{`  const variable = "value";`}</Code>
    <Paragraph>this is and example.</Paragraph>
  </>))
  test(`l("inlineCode")`, () => expectRender(l.markdown('inlineCode'), <Paragraph>inline <Code inline>code</Code> example.</Paragraph>))
  test(`l("highlightCode")`, () => expectRender(l.markdown('highlightCode'), <>
    <Paragraph>code block:</Paragraph>
